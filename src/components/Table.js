        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Name
                    <button onclick={props.sortNames}><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-sort-alpha-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
